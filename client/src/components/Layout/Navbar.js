  ...
  return (
    <nav className="navbar">
      ...
      <ul className={`navbar-menu ${isMobileMenuOpen ? 'active' : ''}`}>
        ...
        <li>
          <Link to="/purchase-orders" className={isActive('/purchase-orders') ? 'active' : ''}>
            Purchase Order
          </Link>
        </li>
        <li>
          <Link to="/sales-orders" className={isActive('/sales-orders') ? 'active' : ''}>
            Sales Order
          </Link>
        </li>
        <li>
        ...
        <li>
          <Link to="/algorithms" className={isActive('/algorithms') ? 'active' : ''}>
            Algorithms
          </Link>
        </li>
        {isAdmin && (
